...
export default {
    ...
    return {
      columns: [
        { id: 0,
          ...
          email: 'glenn.williams@mail.net',
          company: 'ProductDen',
          actions: ['Edit', 'Delete']
        },
        { id: 1,
          fullName: 'Lex Maier',
          email: 'lex.mai@mail.net',
          company: 'ProductDen',
          actions: ['Edit', 'Delete']
        },
        { id: 2,
          fullName: 'Jin Vlasov',
          email: 'jin.borenasosna@mail.net',
          company: 'ProductDen',
          actions: ['Edit', 'Delete']
        },
        { id: 3,
          fullName: 'Charles Johanson',
          email: 'worldwidewanterpreneur@mail.net',
          company: 'ProductDen',
          actions: ['Edit', 'Delete']
        },
        { id: 4,
  ...
  methods: {
    createActionLinks (id, links) {
      ...
      + `<a class="user-table-actions" href="#delete-${id}">${links[1]}</a>`
    },
    handleAction (e) {
